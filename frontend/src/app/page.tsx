...
export default function HomePage() {
  ...
  return (
    <main className="min-h-screen bg-white text-black pb-24">
      {/* 1. 頂部即時市場跑馬燈 (改為白底黑字) */}
      <div className="bg-gray-50 py-2 overflow-hidden border-b border-gray-100 flex items-center">
      ...
      <div className="container-padding pt-6 max-w-2xl mx-auto">
        ...
        <header className="mb-6 flex justify-between items-end">
          <div>
            <h1 className="text-2xl font-black text-black tracking-tight italic uppercase">TRADING AGENT</h1>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          ...
          <Link href="/history" className="bg-white border-2 border-black p-4 rounded-xl flex flex-col justify-between hover:bg-gray-50 transition-all h-32">
            <HistoryIcon className="w-8 h-8 text-black self-end" />
            <div>
              <h3 className="text-black font-black text-lg italic leading-none">歷史紀錄</h3>
        ...
        <div 
          ...
          className="bg-gray-50 rounded-xl p-4 border border-gray-100 mb-6 cursor-pointer hover:border-orange-500 transition-colors group shadow-sm"
        >
            ...
            {steps.map((step, i) => (
              <div key={i} className="flex-none flex items-center">
                <div className="flex flex-col items-center">
                  <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center mb-1 border border-gray-200 group-hover:border-orange-500 transition-colors shadow-sm">
        ...
        {isDrawerOpen && (
          <div className="fixed inset-0 z-50 flex items-end justify-center px-4">
            ...
            <div className="relative bg-white w-full max-w-lg rounded-t-3xl p-6 pb-28 shadow-2xl border-t border-gray-100 animate-in fade-in slide-in-from-bottom-10 duration-300">
              <div className="w-12 h-1 bg-gray-200 rounded-full mx-auto mb-6" />
              
              <div className="flex justify-between items-start mb-6 px-1">
                <div>
                  <h3 className="text-xl font-black text-black uppercase italic">智能分析模組流程</h3>
              ...
              <div className="space-y-3">
                {steps.map((step, i) => (
                  <button 
                    ...
                    className="w-full flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100 hover:border-orange-500 hover:bg-white transition-all text-left group active:scale-[0.98]"
                  >
                    <div className="w-12 h-12 rounded-xl bg-white flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform shadow-sm">
                      <step.icon className={`w-7 h-7 ${step.color}`} />
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex justify-between items-center">
                        <h4 className="text-sm font-black text-black group-hover:text-orange-600 transition-colors">{step.label}</h4>
        ...
        <div>
          <div className="flex items-center justify-between mb-4 px-1">
            <h2 className="font-black text-sm text-black uppercase tracking-widest italic">觀察列表</h2>
